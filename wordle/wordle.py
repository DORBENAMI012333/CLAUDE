...
WORDS = [
    ...
    "beady", "ready", "heady", "leady", "leads", "beads", "meads", "heads",
    ...
    "brute", "prune", "prude", "pride", "gripe", "tripe", "trice", "prick",
    ...
    "track", "trace", "truce", "pruce", "price", "prize", "prose", "probe",
    "globe", "grobe", "grove", "prove", "crave", "shove", "above", "glove",
